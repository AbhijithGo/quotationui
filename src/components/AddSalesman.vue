<template>
  <div >
    <b-container fluid class="card estimateContainer" id="titleConatainer">
      <b-row class="my-1">
        <label v-if="this.toggleData == true" id="titleLable" class="label">Add Salesman</label>
        <label v-else id="titleLable" class="label">Edit Salesman</label>
      </b-row>
    </b-container>
     ...
     <b-form inline @submit="onSubmit" @reset="onReset" v-if="show">
      ...
      <b-row class="my-1">
        <b-col sm="3">
          ...
          <b-form-input class="rowInput " v-model="form.service_code" size="md" type="text" required placeholder="Enter Name"></b-form-input>
        </b-col>
        ...
        <b-col sm="3">
          ...
          <b-form-input class="rowInput " v-model="form.description" size="md" type="text" required placeholder=" Enter Phone"></b-form-input>
        </b-col>
        ...
        <b-col sm="3">
         ...
         <b-form-input class="rowInput " v-model="form.description" size="md" type="text" required placeholder="Enter Email"></b-form-input>
          <div class="mt-3">
          </div>
        </b-col>
      </b-row>
            ...
            <b-row class="my-1">
                <b-button class="yellow submitBtn" type="submit">Submit</b-button>
...
export default {
  ...
  props: ['editRowData', 'toggleRequest'],
